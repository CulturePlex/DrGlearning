...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relational.graph_edges'
        db.alter_column('activities_relational', 'graph_edges', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Relational.graph_nodes'
        db.alter_column('activities_relational', 'graph_nodes', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Relational.scored_nodes'
        db.alter_column('activities_relational', 'scored_nodes', self.gf('jsonfield.fields.JSONField')())


    def backwards(self, orm):
        
        # Changing field 'Relational.graph_edges'
        db.alter_column('activities_relational', 'graph_edges', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Relational.graph_nodes'
        db.alter_column('activities_relational', 'graph_nodes', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Relational.scored_nodes'
        db.alter_column('activities_relational', 'scored_nodes', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'activities.relational': {
            ...
            'activity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['activities.Activity']", 'unique': 'True', 'primary_key': 'True'}),
            'graph_edges': ('jsonfield.fields.JSONField', [], {}),
            'graph_nodes': ('jsonfield.fields.JSONField', [], {}),
            'scored_nodes': ('jsonfield.fields.JSONField', [], {}),
