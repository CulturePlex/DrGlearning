...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.reward'
        db.add_column('activities_activity', 'reward', self.gf('django.db.models.fields.CharField')(default='OK!', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.reward'
        db.delete_column('activities_activity', 'reward')
