...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.level_order'
        db.alter_column('activities_activity', 'level_order', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Activity.level_order'
        db.alter_column('activities_activity', 'level_order', self.gf('django.db.models.fields.IntegerField')(null=True))
