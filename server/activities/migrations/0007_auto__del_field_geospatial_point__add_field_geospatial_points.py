...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Geospatial.points'
        db.add_column('activities_geospatial', 'points', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(default='MULTIPOINT (10 40, 40 30, 20 20, 30 10)'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Geospatial.point'
        db.add_column('activities_geospatial', 'point', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(default=''), keep_default=False)

        # Deleting field 'Geospatial.points'
        db.delete_column('activities_geospatial', 'points')
