...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.query'
        db.alter_column('activities_activity', 'query', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Activity.query'
        db.alter_column('activities_activity', 'query', self.gf('django.db.models.fields.TextField')())
