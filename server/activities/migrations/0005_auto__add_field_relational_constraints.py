...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relational.constraints'
        db.add_column('activities_relational', 'constraints', self.gf('jsonfield.fields.JSONField')(default='[]'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Relational.constraints'
        db.delete_column('activities_relational', 'constraints')
