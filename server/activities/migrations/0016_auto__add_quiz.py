...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Quiz'
        db.create_table('activities_quiz', (
            ...
            ('obfuscated_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('answers', self.gf('jsonfield.fields.JSONField')(default='[]')),
            ('correct_answer', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('time', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('activities', ['Quiz'])


    def backwards(self, orm):
        
        # Deleting model 'Quiz'
        db.delete_table('activities_quiz')
