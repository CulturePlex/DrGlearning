...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visual.answers'
        db.alter_column('activities_visual', 'answers', self.gf('jsonfield.fields.JSONField')())


    def backwards(self, orm):
        
        # Changing field 'Visual.answers'
        db.alter_column('activities_visual', 'answers', self.gf('django.db.models.fields.TextField')())
