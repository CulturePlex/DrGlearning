...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Linguistic.answer'
        db.alter_column('activities_linguistic', 'answer', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Linguistic.locked_text'
        db.alter_column('activities_linguistic', 'locked_text', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Linguistic.answer'
        db.alter_column('activities_linguistic', 'answer', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Linguistic.locked_text'
        db.alter_column('activities_linguistic', 'locked_text', self.gf('django.db.models.fields.TextField')())
