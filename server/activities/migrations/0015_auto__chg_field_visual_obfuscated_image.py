...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visual.obfuscated_image'
        db.alter_column('activities_visual', 'obfuscated_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Visual.obfuscated_image'
        db.alter_column('activities_visual', 'obfuscated_image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
    ...
    models = {
        ...
        'activities.visual': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'obfuscated_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
