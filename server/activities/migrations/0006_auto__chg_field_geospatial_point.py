...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Geospatial.point'
        db.alter_column('activities_geospatial', 'point', self.gf('django.contrib.gis.db.models.fields.MultiPointField')())


    def backwards(self, orm):
        
        # Changing field 'Geospatial.point'
        db.alter_column('activities_geospatial', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')())
    ...
    models = {
        ...
        'activities.geospatial': {
            ...
            'point': ('django.contrib.gis.db.models.fields.MultiPointField', [], {}),
