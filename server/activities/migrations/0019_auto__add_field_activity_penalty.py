...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.penalty'
        db.add_column('activities_activity', 'penalty', self.gf('django.db.models.fields.CharField')(default='Ooops, try again!', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.penalty'
        db.delete_column('activities_activity', 'penalty')
