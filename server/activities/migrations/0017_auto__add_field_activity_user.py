...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('activities_activity', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.user'
        db.delete_column('activities_activity', 'user_id')
