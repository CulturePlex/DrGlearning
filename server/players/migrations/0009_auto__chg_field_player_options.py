...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.options'
        db.alter_column('players_player', 'options', self.gf('jsonfield.fields.JSONField')())


    def backwards(self, orm):
        
        # Changing field 'Player.options'
        db.alter_column('players_player', 'options', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 15, 33, 8, 746710)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 15, 33, 8, 746595)'}),
