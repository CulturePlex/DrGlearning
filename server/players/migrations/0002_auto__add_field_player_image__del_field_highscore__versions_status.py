...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('players_player', 'image', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100), keep_default=False)

        # Deleting field 'HighScore._versions_status'
        db.delete_column('players_highscore', '_versions_status')


    def backwards(self, orm):
        
        # Deleting field 'Player.image'
        db.delete_column('players_player', 'image')

        # Adding field 'HighScore._versions_status'
        db.add_column('players_highscore', '_versions_status', self.gf('django.db.models.fields.PositiveIntegerField')(default=2), keep_default=False)
