...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.image'
        db.alter_column('players_player', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Player.image'
        raise RuntimeError("Cannot reverse this migration. 'Player.image' and its values cannot be restored.")
