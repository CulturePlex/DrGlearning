...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.token'
        db.add_column('players_player', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.token'
        db.delete_column('players_player', 'token')
