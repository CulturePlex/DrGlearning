...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HighScore.activity_timestamp'
        db.add_column('players_highscore', 'activity_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HighScore.activity_timestamp'
        db.delete_column('players_highscore', 'activity_timestamp')
