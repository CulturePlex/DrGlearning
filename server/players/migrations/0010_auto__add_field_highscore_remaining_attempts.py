...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HighScore.remaining_attempts'
        db.add_column('players_highscore', 'remaining_attempts', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HighScore.remaining_attempts'
        db.delete_column('players_highscore', 'remaining_attempts')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 16, 45, 12, 855506)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 16, 45, 12, 855437)'}),
        ...
        'players.highscore': {
            'Meta': {'ordering': "['-score']", 'object_name': 'HighScore'},
            ...
            'remaining_attempts': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'players.player': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'options': ('jsonfield.fields.JSONField', [], {'default': "u'{}'"}),
