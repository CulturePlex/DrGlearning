...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenuineUser.institution_url'
        db.add_column('knowledges_genuineuser', 'institution_url', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenuineUser.institution_url'
        db.delete_column('knowledges_genuineuser', 'institution_url')
