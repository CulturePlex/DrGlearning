...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Career.description'
        db.alter_column('knowledges_career', 'description', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Career.description'
        db.alter_column('knowledges_career', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))
