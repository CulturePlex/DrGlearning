...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Career.total_downloads'
        db.add_column('knowledges_career', 'total_downloads', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Career.total_downloads'
        db.delete_column('knowledges_career', 'total_downloads')
