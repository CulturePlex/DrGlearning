...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Career.image'
        db.add_column('knowledges_career', 'image', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Career.image'
        db.delete_column('knowledges_career', 'image')
