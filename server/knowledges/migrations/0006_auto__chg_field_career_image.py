...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Career.image'
        db.alter_column('knowledges_career', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Career.image'
        raise RuntimeError("Cannot reverse this migration. 'Career.image' and its values cannot be restored.")
