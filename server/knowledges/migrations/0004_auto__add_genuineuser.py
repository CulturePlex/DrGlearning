...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GenuineUser'
        db.create_table('knowledges_genuineuser', (
            ('user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('has_authenticity', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('knowledges', ['GenuineUser'])


    def backwards(self, orm):
        
        # Deleting model 'GenuineUser'
        db.delete_table('knowledges_genuineuser')
