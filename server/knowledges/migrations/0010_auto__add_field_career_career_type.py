...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Career.career_type'
        db.add_column('knowledges_career', 'career_type', self.gf('django.db.models.fields.CharField')(default='explore', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Career.career_type'
        db.delete_column('knowledges_career', 'career_type')
