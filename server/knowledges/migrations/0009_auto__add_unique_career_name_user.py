...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Career', fields ['name', 'user']
        db.create_unique('knowledges_career', ['name', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Career', fields ['name', 'user']
        db.delete_unique('knowledges_career', ['name', 'user_id'])
