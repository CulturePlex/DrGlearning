...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Career.language_code'
        db.add_column('knowledges_career', 'language_code', self.gf('django.db.models.fields.CharField')(default='en', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Career.language_code'
        db.delete_column('knowledges_career', 'language_code')
