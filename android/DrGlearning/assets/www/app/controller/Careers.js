...
Ext.define('DrGlearning.controller.Careers', {
    ...
    initializate: function(){
		...
		this.getController('Levels').initializate();
		this.getController('Activities').initializate();
	...
	addOrStartCareer: function(list, career){
		...
		{
			this.getController('Levels').updateCareer(career);
