				...
				'<div style="display:table; width:100%;">',
					...
					'<div style="display:table-cell; vertical-align: middle; float:right;">',
					    '<tpl if= "career_type == \'exam\'">',
				       		'<img class = "examIcon" vertical-align= "middle" id="examInfo" height="25" src="resources/images/exam.png">',
						'</tpl>',
						'<tpl if= "installed == true">',
							'<tpl if= "update == false">',
				       		'<img hspace="2" vertical-align= "middle" id="uninstall" height="45" src="resources/images/settings.png">',
							'</tpl>',
				        	'<tpl if= "update == true">',
				        	'<img hspace="2" vertical-align= "middle" id="update" height="45" src="resources/images/settingsU.png">',
				        	'</tpl>',
						'</tpl>',
						'<tpl if= "installed == false">',
				       		'<img hspace="2" class = "installIcon" vertical-align= "middle" height="25" src="resources/images/plus.png">',
				        '</tpl>',
					'</div>',
				'</div>',
				'<tpl if= "installed == true">',
